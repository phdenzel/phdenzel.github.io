...
let ge = new GeometryEngine([A, B, C]);
...
function handleDown(e) {
    ...
    let ds = ge.triangle.edgeDistances(z);
    let dsIdx = ge.triangle.argMinDistance(z);
...
function handleMove(e) {
    ...
    if (grabbed >= 0) {
        let edges = ge.triangle.edges;
        edges[grabbed] = z;
        ge.triangle.edges = edges;
        updateAllCanvas();
    }
